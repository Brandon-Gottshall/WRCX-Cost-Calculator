...
import { ChevronDown, Cpu, HardDrive, Network, Info, Settings } from "lucide-react"
          ...
          <div className="grid grid-cols-2 mb-6">
            <button
              ...
              className={`py-2 text-center ${
                activeTab === "recommended" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
              }`}
            >
              Recommended
            </button>
